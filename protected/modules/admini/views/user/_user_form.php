    ...
    <div class="row placeholders">
        <div class="table-responsive" style="line-height: 30px;text-align: left;text-indent: 3px;"> 
            ...
            <table style="width: 100%;border: solid thin #cccccc;" class="table table-striped">
                <tbody> 
                    ...
                    <tr style="border-bottom: 1px solid #cccccc;">
                        <td   style="width: 50%">用户(手机号)：<?php echo $form->textField($model, 'username', array('size' => 20, 'maxlength' => 20, 'class' => 'validate[required]')); ?></td><td  >密码：<?php if ($model->isNewRecord): ?>
            ...
            <table  style="width: 100%;border: solid thin #cccccc;border-top-width: 0px;" class="table table-striped">
                ...
                <tr style="border-bottom: 1px solid #cccccc;">
                    <td   style="width: 50%"  style="text-align: left;border-right: 1px solid #cccccc;">用户组：<select name="User[group_id]">
                            ...
                            <?php endforeach; ?>
                        </select></td> <td >状态：<?php echo $form->dropDownList($model, 'status_is', array('1' => '待审核', '2' => '退回', '3' => '审核通过', '4' => '关闭')); ?></td>
                </tr>
                <tr><td colspan="2">
                        <div id="box"> 
                            <div id="test" ></div>
